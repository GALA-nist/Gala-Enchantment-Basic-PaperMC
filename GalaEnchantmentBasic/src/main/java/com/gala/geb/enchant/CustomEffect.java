...
public enum CustomEffect {
     ...
     * flight). Flying drains boot durability; low durability locks flight
     * until repaired. No fall protection when flight cuts out! Max level I.
     */
    DREAMCATCHER("Dreamcatcher", Material.FEATHER, 1,
            EnumSet.of(ItemKind.BOOTS),
            "While worn: double-jump to fly.\n"
                    + "Flying slowly drains boot durability.\n"
                    + "Low durability locks flight - repair to fly again.\n"
                    + "WARNING: no fall protection if flight cuts out!");
